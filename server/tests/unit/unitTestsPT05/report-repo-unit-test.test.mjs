...
// --- COMMON MOCK DATA ---
const mockReportData = {title: "Pothole", description: "Test", userId: 42, categoryId: 1};
const mockSequelizeReport = {id: 1, ...mockReportData};

// Reusable query options for includes
const includeUserAndCategory = [
    {model: mockDb.User, as: "user", attributes: ["id", "username", "firstName", "lastName", "photoURL"]},
    {model: mockDb.Category, as: "category"},
];
...
describe("Report Repository", () => {
    ...
    describe("updateReport", () => {
        ...
        it("should return true if one row was updated", async () => {
            ...
            expect(mockReportModel.update).toHaveBeenCalledWith(updateData, {where: {id}});
